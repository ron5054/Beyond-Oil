...
export const Branches: CollectionConfig = {
  ...
  fields: [
    { name: 'chain', type: 'text', required: true, minLength: 1 },
    { name: 'logo', type: 'text' },
    {
      name: 'filterTime',
      type: 'select',
    ...
    { name: 'branchName', type: 'text', required: true, minLength: 1 },
    { name: 'branchCode', type: 'text', required: true, minLength: 1 },
    { name: 'phoneNumber', type: 'text', minLength: 1 },
    { name: 'address', type: 'text', minLength: 1 },
    { name: 'city', type: 'text', minLength: 1 },
    { name: 'state', type: 'text', minLength: 1 },
    { name: 'zipCode', type: 'text', minLength: 1 },
