...
const CountryCodeCombobox = ({ value, onChange }: CountryCodeComboboxProps) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="font-normal text-[1rem]">{value}</span>
      </Button>
        ...
        <div className="absolute z-50 mt-1 w-full rounded-md border border-gray-200 bg-white shadow-lg">
          ...
          <div className="max-h-60 overflow-auto">
            {filteredCountries.length === 0 ? (
              <div className="p-2 text-center text-sm text-gray-500">No country found</div>
            ) : (
              <ul>
                {filteredCountries.map((country) => (
                  <li
                    ...
                    className={cn(
                      'px-2 py-1.5 text-[.7rem] cursor-pointer flex justify-between items-center hover:bg-gray-100',
